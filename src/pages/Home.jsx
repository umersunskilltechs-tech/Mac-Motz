...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ArchiveRail is `position: fixed`, so it stays on screen through the
          whole page scroll — every section below needs to leave it a lane,
          not just the parts it happens to sit over at one scroll position.
          The rail is docked flush right on small screens and inset on lg+,
          so the reserve grows to match. */}
